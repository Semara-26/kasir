...
// Pengecekan Akses (hanya admin & manajer)
...
$from = $_GET['from'] ?? 'barang.php'; // Menentukan halaman kembali
...
// ====================================================================
// BAGIAN KODE YANG ANDA MINTA, DIMASUKKAN KEMBALI KE SINI
// ====================================================================
...
if ($data_cek['jumlah'] > 0) {
    // Jika barang sudah pernah terjual, set pesan error dan kembali.
...
// Arahkan kembali ke halaman yang sesuai di akhir
